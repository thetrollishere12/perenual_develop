...
Route::screen('article/{article?}', PostEditScreen::class)
    ->name('platform.article.edit');

Route::screen('articles', PostListScreen::class)
    ->name('platform.article.list');



Route::screen('product/{article?}', ProductEditScreen::class)
...
Route::screen('shop/{article?}', StoreEditScreen::class)
    ->name('platform.shop.edit');

Route::screen('shops', StoreListScreen::class)
    ->name('platform.shop.list');


Route::screen('faq/{article?}', FaqEditScreen::class)
